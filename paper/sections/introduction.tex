...
\begin{enumerate}
  ...
  \item It provides a frozen 2020 run, generated evidence tables, and a
  deliberately non-identical post-hoc baseline comparison whose mixed results
  reveal the roles of sensor selection and temporal aggregation.
\end{enumerate}

The results precede the limitations and conclusion so that the honesty ledger
can be read against concrete evidence. TRACE-C ranks the sustained relational
episode Storm Atiyah first, whereas reconstruction methods isolate the short
2019 frequency event better. The frozen 2020 run produces no selected alerts.
These are neither uniformly positive nor uniformly negative outcomes; they
define the operating envelope supported by the present evidence.
